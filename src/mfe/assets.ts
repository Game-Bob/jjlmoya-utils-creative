...
const UTILITY_ASSET_ROOT = "/_utilities/creative";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/creative/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/creative/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("creative");
